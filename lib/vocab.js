...
const ATTRIBUTE_KINDS = {
  ...
  'remark': 'remark',
  /*
   * The U.S. export-control fields. Missing until now for an instructive
   * reason: this table was written against a snapshot that had no BIS or State
   * records in it, because their source had been broken since 2026-07-28. The
   * moment the feed came back the quality gate reported attributeUnclassified
   * at 15.4% against a 10% floor and named them — which is the gate doing
   * exactly what it exists for, on its author.
   */
  'licence requirement': 'licence',
  'license requirement': 'licence',
  'licence policy': 'licence',
  'license policy': 'licence',
  'standard order': 'licence',
  'federal register notice': 'program_info',
  'end date': 'program_date',
  'call sign': 'vessel',
};
